...
export const AutoCutPanel = ({
  ...
  return (
    <motion.div
      ...
      exit={{ y: 0 }}
      className="absolute bottom-20 left-0 right-0 bg-white border-t border-zinc-200 dark:border-zinc-800 dark:bg-black p-4 z-10 max-h-80 overflow-hidden flex flex-col"
    >
      {/* Header */}
